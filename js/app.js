(function($) {  
    ...
    function calcPension(input) {
        ...
        for (var i = 2; i < diff; i++) {
            ...
            summ1 = summ2;
            summ2 = ((summ1 + deposit)  * _rate + summ1 + deposit).toFixed(2);
        } //Накопленная сумма
        var payment1 = (summ2 / _period).toFixed(0); // Первая выплата за месяц
        var summ3 = 0;
        var payment2 = 0;
        var summ4 = parseInt(payment1);
        var summ = summ2 - payment1;//Сумма без первой выплаты
        ...
        // summ4 - сумма всех выплат
        var average = summ4 / _period; // Средняя пенсионая выплата
        ...
        if (switchBtnLeft && switchBtnRight) {
            ...
            function maleImg () {
                if (age <= 25) {
                    $('.person-left').css('background-image', 'url(/bitrix/templates/.default/images/img/male-18.png)');
                } else if (age >= 26 && age <= 35) {
                    $('.person-left').css('background-image', 'url(/bitrix/templates/.default/images/img/male-26.png)');
                } else if (age >= 36 && age <= 47 ) {
                    $('.person-left').css('background-image', 'url(/bitrix/templates/.default/images/img/male-36.png)');
                } else if (age >= 48 && age <= 65 ) {
                    $('.person-left').css('background-image', 'url(/bitrix/templates/.default/images/img/male-48.png)');
            ...
            function femaleImg () {
                if (age <= 25) {
                    $('.person-left').css('background-image', 'url(/bitrix/templates/.default/images/img/female-18.png)');
                    $('.person-right').css('background-image', 'url(/bitrix/templates/.default/images/img/female-48m.png)');
                } else if (age >= 26 && age <= 35) {
                    $('.person-left').css('background-image', 'url(/bitrix/templates/.default/images/img/female-26.png)');
                } else if (age >= 36 && age <= 47 ) {
                    $('.person-left').css('background-image', 'url(/bitrix/templates/.default/images/img/female-36.png)');
                } else if (age >= 48 && age <= 65 ) {
                    $('.person-left').css('background-image', 'url(/bitrix/templates/.default/images/img/female-48m.png)');
                } if (_average >= 1 && _average <= 2500) {
                    $('.person-right').css('background-image', 'url(/bitrix/templates/.default/images/img/female-48m.png)');
                } else if (_average > 2500 && _average <= 20000) {
                    $('.person-right').css('background-image', 'url(/bitrix/templates/.default/images/img/female-48m.png)');
